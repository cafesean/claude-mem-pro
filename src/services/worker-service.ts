...
import { DevWorkflowRoutes } from './worker/http/routes/DevWorkflowRoutes.js';
import { TrainingRoutes } from './worker/http/routes/TrainingRoutes.js';
...
export class WorkerService implements WorkerRef {
  ...
  private registerRoutes(): void {
    ...
    this.server.registerRoutes(new DevWorkflowRoutes(this.dbManager));
    this.server.registerRoutes(new TrainingRoutes(this.dbManager));
