...
function registerMarketplace(): void {
  ...
  knownMarketplaces['cafesean'] = {
    source: {
      source: 'github',
      repo: 'cafesean/claude-mem',
    },
...
function registerPlugin(version: string): void {
  ...
  installedPlugins.plugins['claude-mem-pro@cafesean'] = [
    {
      scope: 'user',
...
function enablePluginInClaudeSettings(): void {
  ...
  settings.enabledPlugins['claude-mem-pro@cafesean'] = true;
