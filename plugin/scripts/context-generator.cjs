"use strict";var Ft=Object.create;var H=Object.defineProperty;var Pt=Object.getOwnPropertyDescriptor;var Gt=Object.getOwnPropertyNames;var Ht=Object.getPrototypeOf,jt=Object.prototype.hasOwnProperty;var Xt=(n,e)=>{for(var t in e)H(n,t,{get:e[t],enumerable:!0})},Ae=(n,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Gt(e))!jt.call(n,r)&&r!==t&&H(n,r,{get:()=>e[r],enumerable:!(s=Pt(e,r))||s.enumerable});return n};var U=(n,e,t)=>(t=n!=null?Ft(Ht(n)):{},Ae(e||!n||!n.__esModule?H(t,"default",{value:n,enumerable:!0}):t,n)),Bt=n=>Ae(H({},"__esModule",{value:!0}),n);var Ls={};Xt(Ls,{generateContext:()=>be});module.exports=Bt(Ls);var xt=U(require("path"),1),wt=require("os"),kt=require("fs");var ie=require("bun:sqlite");var f=require("path"),se=require("os"),M=require("fs");var Ce=require("url");var L=require("fs"),Ne=require("path");var ee=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ee||{}),te=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ne.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),r=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ee[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${r} ${o}:${i}:${a}.${d}`}log(e,t,s,r,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=ee[e].padEnd(5),d=t.padEnd(6),_="";r?.correlationId?_=`[${r.correlationId}] `:r?.sessionId&&(_=`[session-${r.sessionId}] `);let c="";if(o!=null)if(o instanceof Error)c=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{c=`
`+JSON.stringify(o,null,2)}catch{c=" "+this.formatData(o)}else c=" "+this.formatData(o);let g="";if(r){let{sessionId:E,memorySessionId:T,correlationId:h,...m}=r;Object.keys(m).length>0&&(g=` {${Object.entries(m).map(([b,S])=>`${b}=${S}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${_}${s}${g}${c}`;if(this.logFilePath)try{(0,L.appendFileSync)(this.logFilePath,p+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),c=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",g={...s,location:c};return this.warn(e,`[HAPPY-PATH] ${t}`,g,r),o}},l=new te;var es={};function Wt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Ce.fileURLToPath)(es.url))}var Vt=Wt();function qt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let n=(0,f.join)((0,se.homedir)(),".claude-mem"),e=(0,f.join)(n,"settings.json");try{if((0,M.existsSync)(e)){let t=JSON.parse((0,M.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return n}var O=qt(),y=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,se.homedir)(),".claude"),xs=(0,f.join)(y,"plugins","marketplaces","cafesean"),Yt=(0,f.join)(O,"archives"),Kt=(0,f.join)(O,"logs"),Jt=(0,f.join)(O,"trash"),Qt=(0,f.join)(O,"backups"),zt=(0,f.join)(O,"modes"),ws=(0,f.join)(O,"settings.json"),Ie=(0,f.join)(O,"claude-mem.db"),Zt=(0,f.join)(O,"vector-db"),Le=(0,f.join)(O,"observer-sessions"),ne=(0,f.basename)(Le),ks=(0,f.join)(y,"settings.json"),$s=(0,f.join)(y,"commands"),Fs=(0,f.join)(y,"CLAUDE.md");function De(n){(0,M.mkdirSync)(n,{recursive:!0})}function Me(){return(0,f.join)(Vt,"..")}var x={dataDir:()=>O,workerPid:()=>(0,f.join)(O,"worker.pid"),serverBetaPid:()=>(0,f.join)(O,".server-beta.pid"),serverBetaPort:()=>(0,f.join)(O,".server-beta.port"),serverBetaRuntime:()=>(0,f.join)(O,".server-beta.runtime.json"),settings:()=>(0,f.join)(O,"settings.json"),database:()=>(0,f.join)(O,"claude-mem.db"),chroma:()=>(0,f.join)(O,"chroma"),combinedCerts:()=>(0,f.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,f.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,f.join)(O,"transcript-watch-state.json"),corpora:()=>(0,f.join)(O,"corpora"),supervisorRegistry:()=>(0,f.join)(O,"supervisor.json"),envFile:()=>(0,f.join)(O,".env"),logsDir:()=>Kt,archives:()=>Yt,trash:()=>Jt,backups:()=>Qt,modes:()=>zt,vectorDb:()=>Zt,observerSessions:()=>Le};var we=require("crypto");var ve=require("os"),Ue=U(require("path"),1);var X=require("fs"),j=U(require("path"),1),w={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function ye(n){let e=j.default.join(n,".git"),t;try{t=(0,X.statSync)(e)}catch(c){return c instanceof Error&&c.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",c),w}if(!t.isFile())return w;let s;try{s=(0,X.readFileSync)(e,"utf-8").trim()}catch(c){return console.warn("[worktree] Failed to read .git file:",c instanceof Error?c.message:String(c)),w}let r=s.match(/^gitdir:\s*(.+)$/);if(!r)return w;let i=r[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return w;let a=i[1],d=j.default.basename(n),_=j.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:_}}function xe(n){return n==="~"||n.startsWith("~/")?n.replace(/^~/,(0,ve.homedir)()):n}function ts(n){if(!n||n.trim()==="")return l.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:n}),"unknown-project";let e=xe(n),t=Ue.default.basename(e);if(t===""){if(process.platform==="win32"){let r=n.match(/^([A-Z]):\\/i);if(r){let i=`drive-${r[1].toUpperCase()}`;return l.info("PROJECT_NAME","Drive root detected",{cwd:n,projectName:i}),i}}return l.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:n}),"unknown-project"}return t}function re(n){let e=ts(n);if(!n)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=xe(n),s=ye(t);if(s.isWorktree&&s.parentProjectName){let r=`${s.parentProjectName}/${e}`;return{primary:r,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,r]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function B(n,e,t){return(0,we.createHash)("sha256").update([n||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function oe(n){if(!n)return[];try{let e=JSON.parse(n);return Array.isArray(e)?e:[String(e)]}catch{return[n]}}var N="claude";function ss(n){return n.trim().toLowerCase().replace(/\s+/g,"-")}function v(n){if(!n)return N;let e=ss(n);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:N}function ke(n){let e=["claude","codex","cursor"];return[...n].sort((t,s)=>{let r=e.indexOf(t),o=e.indexOf(s);return r!==-1||o!==-1?r===-1?1:o===-1?-1:r-o:t.localeCompare(s)})}function ns(n,e){return{customTitle:n,platformSource:e?v(e):void 0}}var W=class{db;constructor(e=Ie){e instanceof ie.Database?this.db=e:(e!==":memory:"&&De(O),this.db=new ie.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn()}dropWorkerPidColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32),s=this.db.query("PRAGMA table_info(pending_messages)").all().some(r=>r.name==="worker_pid");if(!(e&&!s)){if(s)try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),l.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(r){l.warn("DB","Failed to drop worker_pid column from pending_messages",{},r instanceof Error?r:new Error(String(r)));return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}}dropDeadPendingMessagesColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31),t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch"].filter(i=>s.has(i));if(!(e&&o.length===0)){if(o.length>0){this.db.run("BEGIN TRANSACTION");try{this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),l.debug("DB",`Dropped dead column ${i} from pending_messages`);e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()),this.db.run("COMMIT")}catch(i){this.db.run("ROLLBACK"),l.warn("DB","Failed to drop dead columns from pending_messages",{},i instanceof Error?i:new Error(String(i)));return}return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getAllProjects(e){let t=e?v(e):void 0,s=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,r=[ne];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",r.push(N,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...r).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o,type:i,concepts:a,files:d}=t,_=s==="relevance",c=_?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,g=r?`LIMIT ${r}`:"",p=e.map(()=>"?").join(","),E=[...e],T=[];if(o&&(T.push("project = ?"),E.push(o)),i)if(Array.isArray(i)){let S=i.map(()=>"?").join(",");T.push(`type IN (${S})`),E.push(...i)}else T.push("type = ?"),E.push(i);if(a){let S=Array.isArray(a)?a:[a],A=S.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");E.push(...S),T.push(`(${A.join(" OR ")})`)}if(d){let S=Array.isArray(d)?d:[d],A=S.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");S.forEach(D=>{E.push(`%${D}%`,`%${D}%`)}),T.push(`(${A.join(" OR ")})`)}let h=T.length>0?`WHERE id IN (${p}) AND ${T.join(" AND ")}`:`WHERE id IN (${p})`,R=this.db.prepare(`
      SELECT *
      FROM observations
      ${h}
      ${c}
      ${g}
    `).all(...E);if(!_)return R;let b=new Map(R.map(S=>[S.id,S]));return e.map(S=>b.get(S)).filter(S=>!!S)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e)||null}getFilesForSession(e){let s=this.db.prepare(`
      ...
      FROM observations
      WHERE memory_session_id = ?
    `).all(e),r=new Set,o=new Set;for(let i of s)oe(i.files_read).forEach(a=>r.add(a)),oe(i.files_modified).forEach(a=>o.add(a));return{filesRead:Array.from(r),filesModified:Array.from(o)}}getSessionById(e){return this.db.prepare(`
    ...
    `).get(e).count}createSDKSession(e,t,s,r,o){let i=new Date,a=i.getTime(),d=ns(r,o),_=d.platformSource??N,c=this.db.prepare(`
    ...
    `).run(e,t,s,r.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,r,o=0,i,a){let d=i??Date.now(),_=new Date(d).toISOString(),c=B(e,s.title,s.narrative),p=this.db.prepare(`
    ...
    `).get(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),r||null,o,s.agent_type??null,s.agent_id??null,c,_,d,a||null,s.metadata??null);if(p)return{id:p.id,createdAtEpoch:p.created_at_epoch};let E=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,c);if(!E)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${c}`);return{id:E.id,createdAtEpoch:E.created_at_epoch}}storeSummary(e,t,s,r,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),c=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,r||null,o,d,a);return{id:Number(c.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,r,o,i=0,a,d){let _=a??Date.now(),c=new Date(_).toISOString();return this.db.transaction(()=>{let p=[],E=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),T=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let m of s){let R=B(e,m.title,m.narrative),b=E.get(e,t,m.type,m.title,m.subtitle,JSON.stringify(m.facts),m.narrative,JSON.stringify(m.concepts),JSON.stringify(m.files_read),JSON.stringify(m.files_modified),o||null,i,m.agent_type??null,m.agent_id??null,R,c,_,d||null);if(b){p.push(b.id);continue}let S=T.get(e,R);if(!S)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${R}`);p.push(S.id)}let h=null;if(r){let R=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,o||null,i,c,_);h=Number(R.lastInsertRowid)}return{observationIds:p,summaryId:h,createdAtEpoch:_}})()}storeObservationsAndMarkComplete(e,t,s,r,o,i,a,d=0,_,c){let g=_??Date.now(),p=new Date(g).toISOString();return this.db.transaction(()=>{let T=[],h=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),m=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let A of s){let D=B(e,A.title,A.narrative),Oe=h.get(e,t,A.type,A.title,A.subtitle,JSON.stringify(A.facts),A.narrative,JSON.stringify(A.concepts),JSON.stringify(A.files_read),JSON.stringify(A.files_modified),a||null,d,A.agent_type??null,A.agent_id??null,D,p,g,c||null);if(Oe){T.push(Oe.id);continue}let Re=m.get(e,D);if(!Re)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${D}`);T.push(Re.id)}let R;if(r){let D=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,a||null,d,p,g);R=Number(D.lastInsertRowid)}if(this.db.prepare(`
        DELETE FROM pending_messages
        WHERE id = ? AND status = 'processing'
      `).run(o).changes!==1)throw new Error(`storeObservationsAndMarkComplete: failed to complete pending message ${o}`);return{observationIds:T,summaryId:R,createdAtEpoch:g}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=r?`LIMIT ${r}`:"",_=e.map(()=>"?").join(","),c=[...e],g=o?`WHERE id IN (${_}) AND project = ?`:`WHERE id IN (${_})`;o&&c.push(o);let E=this.db.prepare(`
      SELECT * FROM session_summaries
      ${g}
      ${a}
      ${d}
    `).all(...c);if(!i)return E;let T=new Map(E.map(h=>[h.id,h]));return e.map(h=>T.get(h)).filter(h=>!!h)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=r?`LIMIT ${r}`:"",_=e.map(()=>"?").join(","),c=[...e],g=o?"AND s.project = ?":"";o&&c.push(o);let E=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(...c);if(!i)return E;let T=new Map(E.map(h=>[h.id,h]));return e.map(h=>T.get(h)).filter(h=>!!h)}getTimelineAroundTimestamp(e,t=10,s=10,r){return this.getTimelineAroundObservation(null,e,t,s,r)}getTimelineAroundObservation(e,t,s=10,r=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,_;if(e!==null){let m=`
      ...
      `,R=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let b=this.db.prepare(m).all(e,...a,s+1),S=this.db.prepare(R).all(e,...a,r+1);if(b.length===0&&S.length===0)return{observations:[],sessions:[],prompts:[]};d=b.length>0?b[b.length-1].created_at_epoch:t,_=S.length>0?S[S.length-1].created_at_epoch:t}catch(b){return b instanceof Error?l.error("DB","Error getting boundary observations",{project:o},b):l.error("DB","Error getting boundary observations with non-Error",{},new Error(String(b))),{observations:[],sessions:[],prompts:[]}}}else{let m=`
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,...s,...o,t.totalObservationCount)}function me(n,e,t){return n.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+_e)}function Ge(n,e,t){let s=Array.from(t.observationTypes),r=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return n.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
  ...
  `).all(...e,...e,...s,...o,t.totalObservationCount)}function He(n,e,t){let s=e.map(()=>"?").join(",");return n.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t.sessionCount+_e)}function ds(n){return n.replace(/\//g,"-")}function _s(n){if(!n.includes('"type":"assistant"'))return null;let e=JSON.parse(n);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(Fe,"").trim(),t)return t}return null}function us(n){for(let e=n.length-1;e>=0;e--)try{let t=_s(n[e]);if(t)return t}catch(t){t instanceof Error?l.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):l.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function cs(n){try{if(!(0,K.existsSync)(n))return{userMessage:"",assistantMessage:""};let e=(0,K.readFileSync)(n,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(r=>r.trim());return{userMessage:"",assistantMessage:us(t)}}catch(e){return e instanceof Error?l.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:n},e):l.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:n,error:String(e)}),{userMessage:"",assistantMessage:""}}}function pe(n,e,t,s){if(!e.showLastMessage||n.length===0)return{userMessage:"",assistantMessage:""};let r=n.find(d=>d.memory_session_id!==t);if(!r)return{userMessage:"",assistantMessage:""};let o=r.memory_session_id,i=ds(s),a=Pe.default.join(y,"projects",i,`${o}.jsonl`);return cs(a)}function je(n,e){let t=e[0]?.id;return n.map((s,r)=>{let o=r===0?null:e[r+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Ee(n,e){let t=[...n.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,r)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=r.type==="observation"?r.data.created_at_epoch:r.data.displayEpoch;return o-i}),t}function Xe(n,e){return new Set(n.slice(0,e).map(t=>t.id))}var ls={group:"session",windowDays:7,maxBlocks:10,filesPerBlock:4,scanLimit:2e3};function Be(n){if(!n)return"";let e=n.split(`
...
`)[0],t=e.match(/([^/]+)\/\.claude\/worktrees\/([^/]+)/);return t?`${t[1]}/${t[2]}`:(t=e.match(/_specs\/([^/]+)/),t?`_specs/${t[1]}`:(t=e.match(/\.claude\/(?:skills|plugins|agents)\/([^/]+)/),t?`.claude/${t[1]}`:(t=e.match(/\/code\/(?:monorepo|ai)\/([^/]+)/)??e.match(/\/code\/([^/]+)\//),t&&t[1]!==".claude"&&t[1]!=="monorepo"&&t[1]!=="ai"?t[1]:"")))}function J(n){return new Date(n).toISOString().slice(0,10)}function ge(n){return new Date(n).toISOString().slice(5,10)}function qe(n){let e=new Set,t=[];for(let s of n){let r=ms(s.verb??s.tool_name.toLowerCase());e.has(r)||(e.add(r),t.push(r))}return t}function Ye(n,e){let t=new Set,s=[],r=n.filter(i=>We(i.target)),o=r.length>0?r:n.filter(i=>i.target);for(let i of o){let a=ps(i.target);!a||t.has(a)||(t.add(a),s.push(a))}return{shown:s.slice(0,e),extra:Math.max(0,s.length-e)}}function Es(n){let e=new Map;for(let r of n){let o=Ve(r.target);o&&e.set(o,(e.get(o)??0)+1)}if(e.size===0)return{label:"misc",otherAreas:0};let t="",s=-1;for(let[r,o]of e)o>s&&(t=r,s=o);return{label:t,otherAreas:e.size-1}}function gs(n,e,t){let s=e.map(()=>"?").join(","),r=t.nowEpoch??Date.now(),o=[...e],i=`project IN (${s})`;return t.windowDays>0&&(i+=" AND created_at_epoch >= ?",o.push(r-t.windowDays*864e5)),o.push(t.scanLimit),n.prepare(`SELECT tool_name, target, verb, content_session_id, created_at_epoch
       FROM mutations
       WHERE ${i}
       ORDER BY created_at_epoch DESC
       LIMIT ?`).all(...o)}function Ts(n,e){let t=["## Recent changes (durable mutations)",""],s="",r=new Set,o=0;for(let i of n){if(o>=e.maxBlocks)break;let a=J(i.created_at_epoch);a!==s&&(t.push(`### ${a}`),s=a,r.clear());let d=i.verb??i.tool_name.toLowerCase(),_=Be(i.target),c=`${d}::${_}`;r.has(c)||(r.add(c),t.push(`- ${d}: ${_||"(external)"}`),o++)}return t.push(""),t}function fs(n,e){let t=new Map;for(let i of n){let a=t.get(i.content_session_id);a?a.push(i):t.set(i.content_session_id,[i])}let s=[...t.values()].map(i=>({rs:i,latest:i[0].created_at_epoch})).sort((i,a)=>a.latest-i.latest).slice(0,e.maxBlocks),r=["## Recent work (by session)",""],o="";for(let{rs:i,latest:a}of s){let d=J(a);d!==o&&(r.push(`### ${d}`),o=d);let{label:_,otherAreas:c}=Es(i),g=qe(i).join(", "),p=c>0?` +${c} area${c>1?"s":""}`:"";r.push(`- ${_} \u2014 ${i.length} change${i.length>1?"s":""} (${g})${p}`);let{shown:E,extra:T}=Ye(i,e.filesPerBlock);if(E.length>0){let h=T>0?` +${T} more`:"";r.push(`  ${E.join(", ")}${h}`)}}return r.push(""),r}function Ss(n,e){let t=new Map;for(let i of n){let a=Ve(i.target)||"misc",d=t.get(a);d?d.push(i):t.set(a,[i])}let s=[...t.entries()].map(([i,a])=>({label:i,rs:a,latest:a[0].created_at_epoch})).sort((i,a)=>a.rs.length-i.rs.length||a.latest-i.latest).slice(0,e.maxBlocks),o=[`## Recent changes by area${e.windowDays>0?` (last ${e.windowDays} days)`:""}`,""];for(let{label:i,rs:a}of s){let d=qe(a).join(", "),_=a[0].created_at_epoch,c=a[a.length-1].created_at_epoch,g=J(_)===J(c)?ge(_):`${ge(c)}\u2192${ge(_)}`;o.push(`- ${i} \u2014 ${a.length} change${a.length>1?"s":""} \xB7 ${d} \xB7 ${g}`);let{shown:p,extra:E}=Ye(a,e.filesPerBlock);if(p.length>0){let T=E>0?` +${E} more`:"";o.push(`  ${p.join(", ")}${T}`)}}return o.push(""),o}function Ke(n,e,t={}){if(e.length===0)return[];let s={...ls,...t},r=gs(n,e,s);if(r.length===0)return[];switch(s.group){case"flat":return Ts(r,s);case"topic":return Ss(r,s);default:return fs(r,s)}}function Je(){let n=new Date,e=n.toLocaleDateString("en-CA"),t=n.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=n.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Qe(n){return[`# [${n}] recent context, ${Je()}`,""]}function ze(){return[`Legend: \u{1F3AF}session ${C.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function Ze(){return[]}function et(){return[]}function tt(n,e){let t=[],s=[`${n.totalObservations} obs (${n.totalReadTokens.toLocaleString()}t read)`,`${n.totalDiscoveryTokens.toLocaleString()}t work`];return n.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${n.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${n.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function st(n){return[`### ${n}`]}function nt(n){return n.toLowerCase().replace(" am","a").replace(" pm","p")}function rt(n,e,t){let s=n.title||"Untitled",r=C.getInstance().getTypeIcon(n.type),o=e?nt(e):'"';return`${n.id} ${o} ${r} ${s}`}function ot(n,e,t,s){let r=[],o=n.title||"Untitled",i=C.getInstance().getTypeIcon(n.type),a=e?nt(e):'"',{readTokens:d,discoveryDisplay:_}=F(n,s);r.push(`**${n.id}** ${a} ${i} **${o}**`),t&&r.push(t);let c=[];return s.showReadTokens&&c.push(`~${d}t`),s.showWorkTokens&&c.push(_),c.length>0&&r.push(c.join(" ")),r.push(""),r}function it(n,e){return[`S${n.id} ${n.request||"Session started"} (${e})`]}function P(n,e){return e?[`**${n}**: ${e}`,""]:[]}function at(n){return n.assistantMessage?["","---","","**Previously**","",`A: ${n.assistantMessage}`,""]:[]}function dt(n,e){return["",`Access ${Math.round(n/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function _t(n){return`# [${n}] recent context, ${Je()}

No previous sessions found.`}function ut(){let n=new Date,e=n.toLocaleDateString("en-CA"),t=n.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=n.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function ct(n){return["",`${u.bright}${u.cyan}[${n}] recent context, ${ut()}${u.reset}`,`${u.gray}${"\u2500".repeat(60)}${u.reset}`,""]}function lt(){let e=C.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${u.dim}Legend: session-request | ${e}${u.reset}`,""]}function mt(){return[`${u.bright}Column Key${u.reset}`,`${u.dim}  Read: Tokens to read this observation (cost to learn it now)${u.reset}`,`${u.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${u.reset}`,""]}function pt(){return[`${u.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${u.reset}`,"",`${u.dim}When you need implementation details, rationale, or debugging context:${u.reset}`,`${u.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${u.reset}`,`${u.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${u.reset}`,`${u.dim}  - Trust this index over re-reading code for past decisions and learnings${u.reset}`,""]}function Et(n,e){let t=[];if(t.push(`${u.bright}${u.cyan}Context Economics${u.reset}`),t.push(`${u.dim}  Loading: ${n.totalObservations} observations (${n.totalReadTokens.toLocaleString()} tokens to read)${u.reset}`),t.push(`${u.dim}  Work investment: ${n.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${u.reset}`),n.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${n.savings.toLocaleString()} tokens (${n.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${n.savings.toLocaleString()} tokens`:s+=`${n.savingsPercent}% reduction from reuse`,t.push(`${u.green}${s}${u.reset}`)}return t.push(""),t}function gt(n){return[`${u.bright}${u.cyan}${n}${u.reset}`,""]}function Tt(n){return[`${u.dim}${n}${u.reset}`]}function ft(n,e,t,s){let r=n.title||"Untitled",o=C.getInstance().getTypeIcon(n.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=F(n,s),_=t?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),c=s.showReadTokens&&i>0?`${u.dim}(~${i}t)${u.reset}`:"",g=s.showWorkTokens&&a>0?`${u.dim}(${d} ${a.toLocaleString()}t)${u.reset}`:"";return`  ${u.dim}#${n.id}${u.reset}  ${_}  ${o}  ${r} ${c} ${g}`}function St(n,e,t,s,r){let o=[],i=n.title||"Untitled",a=C.getInstance().getTypeIcon(n.type),{readTokens:d,discoveryTokens:_,workEmoji:c}=F(n,r),g=t?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),p=r.showReadTokens&&d>0?`${u.dim}(~${d}t)${u.reset}`:"",E=r.showWorkTokens&&_>0?`${u.dim}(${c} ${_.toLocaleString()}t)${u.reset}`:"";return o.push(`  ${u.dim}#${n.id}${u.reset}  ${g}  ${a}  ${u.bright}${i}${u.reset}`),s&&o.push(`    ${u.dim}${s}${u.reset}`),(p||E)&&o.push(`    ${p} ${E}`),o.push(""),o}function ht(n,e){let t=`${n.request||"Session started"} (${e})`;return[`${u.yellow}#S${n.id}${u.reset} ${t}`,""]}function G(n,e,t){return e?[`${t}${n}:${u.reset} ${e}`,""]:[]}function bt(n){return n.assistantMessage?["","---","",`${u.bright}${u.magenta}Previously${u.reset}`,"",`${u.dim}A: ${n.assistantMessage}${u.reset}`,""]:[]}function Ot(n,e){let t=Math.round(n/1e3);return["",`${u.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${u.reset}`]}function Rt(n){return`
${u.bright}${u.cyan}[${n}] recent context, ${ut()}${u.reset}
${u.gray}${"\u2500".repeat(60)}${u.reset}

${u.dim}No previous sessions found for this project yet.${u.reset}
`}function At(n,e,t,s){let r=[];return s?r.push(...ct(n)):r.push(...Qe(n)),s?r.push(...lt()):r.push(...ze()),s?r.push(...mt()):r.push(...Ze()),s?r.push(...pt()):r.push(...et()),Y(t)&&(s?r.push(...Et(e,t)):r.push(...tt(e,t))),r}var Te=U(require("path"),1);function Z(n){if(!n)return[];try{let e=JSON.parse(n);return Array.isArray(e)?e:[]}catch(e){return l.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:n?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function fe(n){return new Date(n).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Se(n){return new Date(n).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Ct(n){return new Date(n).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Nt(n,e){return Te.default.isAbsolute(n)?Te.default.relative(e,n):n}function It(n,e,t){let s=Z(n);if(s.length>0)return Nt(s[0],e);if(t){let r=Z(t);if(r.length>0)return Nt(r[0],e)}return"General"}function hs(n){let e=new Map;for(let s of n){let r=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Ct(r);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,r)=>{let o=new Date(s[0]).getTime(),i=new Date(r[0]).getTime();return o-i});return new Map(t)}function Lt(n,e){return e.fullObservationField==="narrative"?n.narrative:n.facts?Z(n.facts).join(`
`):null}function bs(n,e,t,s){let r=[];r.push(...st(n));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=fe(a.displayTime);r.push(...it(a,d))}else{let a=i.data,d=Se(a.created_at),c=d!==o?d:"";if(o=d,t.has(a.id)){let p=Lt(a,s);r.push(...ot(a,c,p,s))}else r.push(rt(a,c,s))}return r}function Os(n,e,t,s,r){let o=[];o.push(...gt(n));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,c=fe(_.displayTime);o.push(...ht(_,c))}else{let _=d.data,c=It(_.files_modified,r,_.files_read),g=Se(_.created_at),p=g!==a;a=g;let E=t.has(_.id);if(c!==i&&(o.push(...Tt(c)),i=c),E){let T=Lt(_,s);o.push(...St(_,g,p,T,s))}else o.push(ft(_,g,p,s))}return o.push(""),o}function Rs(n,e,t,s,r,o){return o?Os(n,e,t,s,r):bs(n,e,t,s)}function Dt(n,e,t,s,r){let o=[],i=hs(n);for(let[a,d]of i)o.push(...Rs(a,d,e,t,s,r));return o}function Mt(n,e,t){return!(!n.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function yt(n,e){let t=[];return e?(t.push(...G("Investigated",n.investigated,u.blue)),t.push(...G("Learned",n.learned,u.yellow)),t.push(...G("Completed",n.completed,u.green)),t.push(...G("Next Steps",n.next_steps,u.magenta))):(t.push(...P("Investigated",n.investigated)),t.push(...P("Learned",n.learned)),t.push(...P("Completed",n.completed)),t.push(...P("Next Steps",n.next_steps))),t}function vt(n,e){return e?bt(n):at(n)}function Ut(n,e,t){return!Y(e)||n.totalDiscoveryTokens<=0||n.savings<=0?[]:t?Ot(n.totalDiscoveryTokens,n.totalReadTokens):dt(n.totalDiscoveryTokens,n.totalReadTokens)}var As=xt.default.join((0,wt.homedir)(),".claude","plugins","marketplaces","cafesean","plugin",".install-version");function Ns(){try{return new W}catch(n){if(n instanceof Error&&n.code==="ERR_DLOPEN_FAILED"){try{(0,kt.unlinkSync)(As)}catch(e){e instanceof Error?l.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):l.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return l.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw n}}function Cs(n,e){return e?Rt(n):_t(n)}function $t(){return process.env.CLAUDE_MEM_INJECT_MODE==="legacy"?"legacy":"mutations"}function he(n,e){return Number.isFinite(n)?n:e}function Is(n,e,t,s,r,o,i,a,d){let _=[];if($t()==="mutations"){_.push(`# [${n}] recent context, ${new Date().toISOString().slice(0,16).replace("T"," ")}`,"");let b=Ke(a.db,d,{group:s.digestGroup,windowDays:he(s.digestWindowDays,7),maxBlocks:he(s.digestMaxBlocks,10),filesPerBlock:he(s.digestFilesPerBlock,4)});return b.length>0?_.push(...b):_.push("_No durable changes recorded yet for this project._",""),_.push("For deeper recall (past decisions, lessons, specs, session history), use the `recall` skill or `mem-search`."),_.join(`
`).trimEnd()}let c=ce(e);_.push(...At(n,c,s,i));let g=t.slice(0,s.sessionCount),p=je(g,t),E=Ee(e,p),T=Xe(e,s.fullObservationCount);_.push(...Dt(E,T,s,r,i));let h=t[0],m=e[0];Mt(s,h,m)&&_.push(...yt(h,i));let R=pe(e,s,o,r);return _.push(...vt(R,i)),_.push(...Ut(c,s,i)),_.join(`
`).trimEnd()}async function be(n,e=!1){let t=de(),s=n?.cwd??process.cwd(),r=re(s),o=n?.projects?.length?n.projects:r.allProjects,i=o[o.length-1]??r.primary;n?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Ns();if(!a)return"";try{let d=o.length>1?Ge(a,o,t):le(a,i,t),_=o.length>1?He(a,o,t):me(a,i,t);return $t()==="legacy"&&d.length===0&&_.length===0?Cs(i,e):Is(i,d,_,t,s,n?.session_id,e,a,o)}finally{a.close()}}0&&(module.exports={generateContext});
